...
export const ru = {
  ...
  // Hub - UPDATED SLOGANS
  hubTickerPhrases: [
    "ДАННЫЕ СОЗДАЮТ ЛЕГЕНД •",
    "ЧИСЛА НИКОГДА НЕ ВРУТ •",
    "ПОЛЕ РЕШАЕТ ВСЁ •",
    "РЕЗУЛЬТАТ ВАЖНЕЕ СЛОВ •",
    "532 — ГДЕ ИГРАЕТ ЭЛИТА"
  ],
  hubBroadcastHeader: "ТРАНСЛЯЦИЯ",
  hubIntelligenceHeader: "РАЗВЕДДАННЫЕ",
  hubSquadsHeader: "СОСТАВЫ СЕССИИ",
  hubVitalsHeader: "ПОКАЗАТЕЛИ КЛУБА",
  hubGlobalDistribution: "ГЛОБАЛЬНОЕ РАСПРЕДЕЛЕНИЕ",
  ...
  badge_perfect_finish_desc: "3x Игры с 2 голами для перемоги",
