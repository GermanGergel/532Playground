...
export const ru = {
  ...
  hubHallOfFame: "Зал Славы",
  hubEternalGoldenBoot: "ВЕЧНАЯ ЗОЛОТАЯ БУТСА",
  hubCareerGoals: "ГОЛЫ ЗА КАРЬЕРУ",
  hubLegacyArchitect: "АРХИТЕКТОР НАСЛЕДИЯ",
  hubCareerAssists: "АССИСТЫ ЗА КАРЬЕРУ",
  hubGrandMaster: "ГРАНДМАСТЕР",
  hubGoalsAndAssists: "ГОЛЫ + АССИСТЫ",
  hubTheConqueror: "ЗАВОЕВАТЕЛЬ",
  hubHighestWinRate: "ЛУЧШИЙ ПРОЦЕНТ ПОБЕД",
  hubNoData: "НЕТ ДАННЫХ",
  hubNoContenders: "НЕТ ПРЕТЕНДЕНТОВ",
  hubConnectWhatsApp: "Свяжитесь с нами в WhatsApp, чтобы забронировать место.",
