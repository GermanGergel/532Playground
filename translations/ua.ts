export const ua = {
  ...
  ratingCalculationDesc: "Рейтинг змінюється на основе результатів матчу, командної гри та особистого внеску.",
  ...
  badge_team_conductor_desc: "Асисти in 3 перемогах",
