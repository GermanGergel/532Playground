...
export const ua = {
  ...
  hubJoinSquad: "Приєднатися до UNIT",
  hubHallOfFame: "Зала Слави",
  hubEternalGoldenBoot: "ВІЧНА ЗОЛОТА БУТСА",
  hubCareerGoals: "ГОЛИ ЗА КАР'ЄРУ",
  hubLegacyArchitect: "АРХІТЕКТОР СПАДЩИНИ",
  hubCareerAssists: "АСИСТИ ЗА КАР'ЄРУ",
  hubGrandMaster: "ГРАНДМАЙСТЕР",
  hubGoalsAndAssists: "ГОЛИ + АСИСТИ",
  hubTheConqueror: "ЗАВОЙОВНИК",
  hubHighestWinRate: "НАЙКРАЩИЙ ВІДСОТОК ПЕРЕМОГ",
  hubNoData: "НЕМАЄ ДАНИХ",
  hubNoContenders: "НЕМАЄ ПРЕТЕНДЕНТІВ",
  hubConnectWhatsApp: "Зв'яжіться з нами у WhatsApp, щоб забронювати місце.",
