...
export const HubInfo: React.FC = () => {
    ...
    return (
        <div className="absolute inset-0 z-20 flex flex-col animate-in fade-in duration-500 rounded-[2.5rem] overflow-hidden">
            {/* Background: Info Style - Matching Information Color #0a0c10 */}
            <div className="absolute -top-24 bottom-0 -left-4 -right-4 z-0 pointer-events-none bg-[#0a0c10]">
            ...
            <div className="relative z-10 flex-grow overflow-hidden flex flex-col">
                    ...
                    <div className="space-y-16 pb-32 pt-12 w-full max-w-3xl mx-auto px-6">
                        ...
                        <section>
                            ...
                            <div className="space-y-6">
                                ...
                                {/* RATING RULES (Inactivity & Protection) */}
                ...
                {/* SCROLL FADE BOTTOM - Info Background Color #0a0c10 */}
                <div className="absolute bottom-0 left-0 right-0 h-4 bg-gradient-to-t from-[#0a0c10] to-transparent z-30 pointer-events-none"></div>
            </div>
        </div>
    );
};
