...
// --- NEW BADGE ICONS (Finalized System) ---
export const GoleadorBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10 16.5v-2.5m4 2.5v-2.5m-4-2.5v-2.5m4 2.5v-2.5m-7-2.5h10"/><path d="M19 19H5L3 9h18l-2 10z"/><circle cx="12" cy="7" r="2.5"/></svg>
);
// ... (All existing badge icons remain exactly the same) ...
export const PerfectFinishBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="4"/><circle cx="12" cy="12" r="1.5" fill="currentColor"/></svg>
);
export const DynastyBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M5 16L3 7l5.5 3L12 4l3.5 6L21 7l-2 9H5z"/><path d="M8.5 13.5L12 11l3.5 2.5"/></svg>
);
export const SniperBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="8"/><path d="M12 2v4m0 12v4m-8-8H2m20 0h-4"/></svg>
);
export const AssistantBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 14.5a3.5 3.5 0 10-7 0v-1.5a3.5 3.5 0 107 0v1.5z"/><path d="M12.5 12.5h-1a2 2 0 00-2 2v1a2 2 0 002 2h1a2 2 0 002-2v-1a2 2 0 00-2-2z"/><circle cx="8" cy="7" r="2"/></svg>
);
export const MvpBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
);
export const DecisiveFactorBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 4l-8 8m-4-4l4 4"/><path d="M17 14l3 3-3 3"/></svg>
);
export const UnsungHeroBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M12 11.5l.95 2.91 2.8.5-2.12 2.2.62 3.39L12 18.5l-2.25 2 .62-3.39-2.12-2.2 2.8-.5L12 11.5z"/></svg>
);
export const FirstBloodBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 3v18"/><path d="M18 9l-6-6-6 6"/></svg>
);
export const DupletBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2 12h20"/><path d="M12 2v20"/><path d="M18 6l-6 6-6 6"/><path d="M6 6l6 6 6 6"/></svg>
);
export const MaestroBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2L8 7h8L12 2z"/><path d="M12 22L8 17h8l-4 5z"/><path d="M2 12l5-4v8L2 12z"/><path d="M22 12l-5-4v8l5-4z"/></svg>
);
export const ComebackKingsBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M13 17l5-5-5-5"/><path d="M6 17l5-5-5-5"/></svg>
);
export const FortressBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22s-8-4.5-8-11.8A8 8 0 0112 2a8 8 0 018 8.2c0 7.3-8 11.8-8 11.8z"/><path d="M12 7v6"/><path d="M15 10l-3-3-3 3"/></svg>
);
export const ClubLegendBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/><path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/></svg>
);
export const VeteranBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const TenInfluenceBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 15h2a2 2 0 0 1-2 2v2a2 2 0 0 1-2 2H4v-6z"/><path d="M16 15h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-2v-6z"/><path d="M10 9a2 2 0 0 1-2-2V5h4v2a2 2 0 0 1-2 2z"/><path d="M10 15V9"/></svg>;
...
export const WinLeaderBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M13 14l-4-4 4-4"/><path d="M7 10h9.5a2.5 2.5 0 0 1 0 5H11"/></svg>;
...
export const UndefeatedBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14.5 21H8a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v6.5"/><path d="M9 16h2"/><path d="M9 12h4"/><path d="M9 8h4"/><path d="M17.5 14.5l3 3-3 3"/><path d="M20.5 14.5l-3 3 3 3"/></svg>;
export const DominantParticipantBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>;
...
// --- LEGIONNAIRE ICONS ---
export const MercenaryBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="2" y="7" width="20" height="14" rx="2" ry="2" /><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" /></svg>;
export const DoubleAgentBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2 12h20" /><path d="M12 2a10 10 0 0 1 10 10" /><path d="M12 22a10 10 0 0 1-10-10" /><path d="M12 22v-6" /><path d="M12 2v6" /></svg>;
export const JokerBadgeIcon = (props: React.SVGProps<SVGSVGElement>) => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="4" y="2" width="16" height="20" rx="2" /><path d="M9 10a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2" /><path d="M15 10a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2" /></svg>;
...
export const HandshakeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14.5 16.5L12 14l-2.5 2.5"/><path d="M12 14l2.5-2.5L17 14"/><path d="M18 22l-4-4 2-2 4 4-2 2z"/><path d="M6 8l4 4-2 2-4-4 2-2z"/><path d="M10 12L8 14"/><path d="M16 12l-2-2"/></svg>
);
export const CrownIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 6l4 6H8l4-6z"/><path d="M18 18H6l-4-6h20l-4 6z"/></svg>
);
...
export const Cloud = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M17.5 19c0-1.7-1.3-3-3-3h-1.1c-.2-3.4-3.1-6-6.5-6-3.8 0-6.8 3.1-6.8 7s3 7 6.8 7h8a4 4 0 0 0 2.6-7.3Z"/></svg>
);
export const CloudRain = (props: React.SVGProps<SVGSVGElement>) => (
...
export const CloudSnow = (props: React.SVGProps<SVGSVGElement>) => (
...
export const Home = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>
);
export const LayoutDashboard = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="7" height="9" x="3" y="3" rx="1"/><rect width="7" height="5" x="14" y="3" rx="1"/><rect width="7" height="9" x="14" y="12" rx="1"/><rect width="7" height="5" x="3" y="16" rx="1"/></svg>
);
export const BarChartDynamic = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M18 20V4"/><path d="M6 20v-4"/><path d="M12 20v-8"/></svg>
);
export const History = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>
);
...
export const Image = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="m21 15-5-5L5 21"/></svg>
);
...
export const Pause = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="6" y="4" width="4" height="16"></rect><rect x="14" y="4" width="4" height="16"></rect></svg>
);
export const Plus = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
);
...
export const UserMinus = (props: React.SVGProps<SVGSVGElement>) => (
...
export const Edit3 = (props: React.SVGProps<SVGSVGElement>) => (
...
export const Wand = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m21 3-9.5 9.5-2.5 2.5-3-3-2.5 2.5 9.5 9.5 2.5-2.5 3-3 2.5-2.5-9.5-9.5Z"/><path d="m16 8 3 3"/></svg>
);
export const InfoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <circle cx="12" cy="12" r="10" />
        <path d="M12 16.5v.5" stroke="currentColor" strokeLinecap="round" />
        <path d="M12 7.5v6" stroke="currentColor" strokeLinecap="round" />
    </svg>
);
...
export const ZaloIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 50 50" fill="currentColor" {...props}>
        <path d="M43.75 35.625C43.75 39.526 40.526 42.708 36.625 42.708H10.583C9.917 42.708 9.292 42.5 8.75 42.125L5.208 44.583C4.583 45 3.75 44.792 3.542 44.167C3.333 43.542 3.542 42.708 4.167 42.5L7.292 39.583C6.458 38.333 5.833 36.875 5.833 35.208V14.167C5.833 10.266 9.057 7.083 12.958 7.083H36.625C40.526 7.083 43.75 10.266 43.75 14.167V35.625ZM35.417 33.333C35.417 32.708 34.792 32.292 34.167 32.292H15.417C14.792 32.292 14.167 32.708 14.167 33.333C14.167 33.958 14.792 34.375 15.417 34.375H34.167C34.792 34.375 35.417 33.958 35.417 33.333ZM36.625 16.25C37.25 16.25 37.708 15.625 37.708 15C37.708 14.375 37.25 13.958 36.625 13.958H14.167C13.542 13.958 12.917 14.375 12.917 15C12.917 15.625 13.542 16.25 14.167 16.25H16.25L23.75 25.208H14.167C13.542 25.208 12.917 25.625 12.917 26.25C12.917 26.875 13.542 27.292 14.167 27.292H34.167C34.792 27.292 35.417 26.875 35.417 26.25C35.417 25.625 34.792 25.208 34.167 25.208H31.875L24.375 16.25H36.625Z" />
    </svg>
);
