        ...
        return (
            ...
            >
                <img 
                    src={customIcon} 
                    alt="Radio" 
                    className={`w-28 h-28 md:w-36 md:h-36 object-contain transition-all duration-300 ${isPlaying ? 'drop-shadow-[0_0_8px_rgba(0,242,254,0.8)]' : 'opacity-90 hover:opacity-100'}`} 
                />
            </button>
        );
    }
