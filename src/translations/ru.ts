...
export const ru = {
  ...
  // Hub
  hubTickerPhrases: "ДАННЫЕ СОЗДАЮТ ЛЕГЕНД | ЧИСЛА НИКОГДА НЕ ВРУТ | ПОЛЕ РЕШАЕТ ВСЁ | РЕЗУЛЬТАТ ВАЖНЕЕ СЛОВ | 532 — ГДЕ ИГРАЕТ ЭЛИТА",
  ...
  badge_stable_striker_desc: "Серія голов 3 матчі",
