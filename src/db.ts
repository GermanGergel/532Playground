...
// Uses 'any' for the promise argument to accept Supabase PostgrestBuilder without strict type conflicts
const withTimeout = <T>(promise: any, ms: number = 3000): Promise<T> => {
    return Promise.race([
