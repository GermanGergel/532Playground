        ...
        <Page>
            ...
            <div className="flex flex-col gap-6">
                <div className="space-y-6">
                    <Card 
                        className="shadow-lg shadow-dark-accent-start/20 border border-dark-accent-start/40 !px-6 !py-4 bg-dark-surface/80"
                    >
