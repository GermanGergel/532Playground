                                                                        ...
                                                                        game.goals.map((goal, gIdx) => {
                                                                            ...
                                                                            return (
                                                                                <div key={goal.id} className="flex items-center gap-2 px-3 py-1 relative">
                                                                                    ...
                                                                                    <div className="shrink-0 ml-1">{goal.isOwnGoal ? ( <span className="text-[10px] filter drop-shadow-[0_0_5px_rgba(239,68,68,0.5)]">🧤</span> ) : ( <span className="text-[10px] filter drop-shadow-[0_0_5px_rgba(0,242,254,0.5)]">⚽</span> )}</div>
